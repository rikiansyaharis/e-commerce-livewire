...
<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{ asset('admin/assets/images/app-logo.svg') }}" alt="logo"><span class="logo-text">PORTAL</span></a>
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                <li class="nav-item">
                    ...
                    <a class="nav-link {{ (request()->is('apps/dashboard*')) ? 'active' : '' }}" href="{{ route('apps.dashboard')}}">
                        <span class="nav-icon">
  ...
  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ (request()->is('apps/category*')) ? 'active' : '' }}" href="{{ route('category.categories')}}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ (request()->is('apps/brand*')) ? 'active' : '' }}" href="{{ route('brand.brands')}}">
                        <span class="nav-icon">
